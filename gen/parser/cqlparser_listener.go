...
type CqlParserListener interface {
	...
	// EnterMvWhereSpec is called when entering the mvWhereSpec production.
	EnterMvWhereSpec(c *MvWhereSpecContext)

	// EnterMvWhereClause is called when entering the mvWhereClause production.
	EnterMvWhereClause(c *MvWhereClauseContext)
	...
	// EnterStaticColumn is called when entering the staticColumn production.
	EnterStaticColumn(c *StaticColumnContext)
	...
	// EnterBatchStatementList is called when entering the batchStatementList production.
	EnterBatchStatementList(c *BatchStatementListContext)

	// EnterBatchStatement is called when entering the batchStatement production.
	EnterBatchStatement(c *BatchStatementContext)

	// EnterBatchInsert is called when entering the batchInsert production.
	EnterBatchInsert(c *BatchInsertContext)

	// EnterBatchUpdate is called when entering the batchUpdate production.
	EnterBatchUpdate(c *BatchUpdateContext)

	// EnterBatchDelete is called when entering the batchDelete production.
	EnterBatchDelete(c *BatchDeleteContext)
	...
	// EnterTabletsSpec is called when entering the tabletsSpec production.
	EnterTabletsSpec(c *TabletsSpecContext)

	// EnterTabletsOptions is called when entering the tabletsOptions production.
	EnterTabletsOptions(c *TabletsOptionsContext)

	// EnterTabletsOption is called when entering the tabletsOption production.
	EnterTabletsOption(c *TabletsOptionContext)
	...
	// EnterIndexUsing is called when entering the indexUsing production.
	EnterIndexUsing(c *IndexUsingContext)
	...
	// EnterIfConditionValue is called when entering the ifConditionValue production.
	EnterIfConditionValue(c *IfConditionValueContext)
	...
	// EnterAssignmentIndexKey is called when entering the assignmentIndexKey production.
	EnterAssignmentIndexKey(c *AssignmentIndexKeyContext)

	// EnterAssignmentSet is called when entering the assignmentSet production.
	EnterAssignmentSet(c *AssignmentSetContext)

	// EnterAssignmentSetElement is called when entering the assignmentSetElement production.
	EnterAssignmentSetElement(c *AssignmentSetElementContext)

	// EnterAssignmentMap is called when entering the assignmentMap production.
	EnterAssignmentMap(c *AssignmentMapContext)

	// EnterAssignmentMapEntry is called when entering the assignmentMapEntry production.
	EnterAssignmentMapEntry(c *AssignmentMapEntryContext)

	// EnterAssignmentMapKey is called when entering the assignmentMapKey production.
	EnterAssignmentMapKey(c *AssignmentMapKeyContext)

	// EnterAssignmentMapValue is called when entering the assignmentMapValue production.
	EnterAssignmentMapValue(c *AssignmentMapValueContext)
	...
	// EnterJsonDefault is called when entering the jsonDefault production.
	EnterJsonDefault(c *JsonDefaultContext)
	...
	// EnterGroupBySpec is called when entering the groupBySpec production.
	EnterGroupBySpec(c *GroupBySpecContext)

	// EnterBypassCacheSpec is called when entering the bypassCacheSpec production.
	EnterBypassCacheSpec(c *BypassCacheSpecContext)

	// EnterPerPartitionLimitSpec is called when entering the perPartitionLimitSpec production.
	EnterPerPartitionLimitSpec(c *PerPartitionLimitSpecContext)

	// EnterUsingTimeoutSpec is called when entering the usingTimeoutSpec production.
	EnterUsingTimeoutSpec(c *UsingTimeoutSpecContext)

	// EnterPruneMaterializedView is called when entering the pruneMaterializedView production.
	EnterPruneMaterializedView(c *PruneMaterializedViewContext)
	...
	// EnterDescribeInternals is called when entering the describeInternals production.
	EnterDescribeInternals(c *DescribeInternalsContext)

	// EnterServiceLevelName is called when entering the serviceLevelName production.
	EnterServiceLevelName(c *ServiceLevelNameContext)

	// EnterServiceLevel is called when entering the serviceLevel production.
	EnterServiceLevel(c *ServiceLevelContext)

	// EnterServiceLevels is called when entering the serviceLevels production.
	EnterServiceLevels(c *ServiceLevelsContext)

	// EnterCreateServiceLevel is called when entering the createServiceLevel production.
	EnterCreateServiceLevel(c *CreateServiceLevelContext)

	// EnterAlterServiceLevel is called when entering the alterServiceLevel production.
	EnterAlterServiceLevel(c *AlterServiceLevelContext)

	// EnterDropServiceLevel is called when entering the dropServiceLevel production.
	EnterDropServiceLevel(c *DropServiceLevelContext)

	// EnterAttachServiceLevel is called when entering the attachServiceLevel production.
	EnterAttachServiceLevel(c *AttachServiceLevelContext)

	// EnterDetachServiceLevel is called when entering the detachServiceLevel production.
	EnterDetachServiceLevel(c *DetachServiceLevelContext)

	// EnterListServiceLevel is called when entering the listServiceLevel production.
	EnterListServiceLevel(c *ListServiceLevelContext)
	...
	// EnterPruneUsingSpec is called when entering the pruneUsingSpec production.
	EnterPruneUsingSpec(c *PruneUsingSpecContext)
	...
	// EnterScyllaClusteringBound is called when entering the scyllaClusteringBound production.
	EnterScyllaClusteringBound(c *ScyllaClusteringBoundContext)

	// EnterFunctionCall is called when entering the functionCall production.
	EnterFunctionCall(c *FunctionCallContext)

	// EnterCastCall is called when entering the castCall production.
	EnterCastCall(c *CastCallContext)

	// EnterQualifiedFunctionCall is called when entering the qualifiedFunctionCall production.
	EnterQualifiedFunctionCall(c *QualifiedFunctionCallContext)
	...
	// EnterNamedMarker is called when entering the namedMarker production.
	EnterNamedMarker(c *NamedMarkerContext)
	...
	// EnterReservedKeywordAsColumn is called when entering the reservedKeywordAsColumn production.
	EnterReservedKeywordAsColumn(c *ReservedKeywordAsColumnContext)

	// EnterColumnRef is called when entering the columnRef production.
	EnterColumnRef(c *ColumnRefContext)

	// EnterReservedKeywordAsTable is called when entering the reservedKeywordAsTable production.
	EnterReservedKeywordAsTable(c *ReservedKeywordAsTableContext)

	// EnterReservedTypeAsTable is called when entering the reservedTypeAsTable production.
	EnterReservedTypeAsTable(c *ReservedTypeAsTableContext)
	...
	// EnterDataTypeArg is called when entering the dataTypeArg production.
	EnterDataTypeArg(c *DataTypeArgContext)
	...
	// EnterKwBypass is called when entering the kwBypass production.
	EnterKwBypass(c *KwBypassContext)

	// EnterKwCache is called when entering the kwCache production.
	EnterKwCache(c *KwCacheContext)

	// EnterKwTimeout is called when entering the kwTimeout production.
	EnterKwTimeout(c *KwTimeoutContext)

	// EnterKwPrune is called when entering the kwPrune production.
	EnterKwPrune(c *KwPruneContext)

	// EnterKwPer is called when entering the kwPer production.
	EnterKwPer(c *KwPerContext)

	// EnterKwPartition is called when entering the kwPartition production.
	EnterKwPartition(c *KwPartitionContext)

	// EnterKwGroup is called when entering the kwGroup production.
	EnterKwGroup(c *KwGroupContext)

	// EnterKwStatic is called when entering the kwStatic production.
	EnterKwStatic(c *KwStaticContext)

	// EnterKwCast is called when entering the kwCast production.
	EnterKwCast(c *KwCastContext)

	// EnterKwLike is called when entering the kwLike production.
	EnterKwLike(c *KwLikeContext)

	// EnterKwWritetime is called when entering the kwWritetime production.
	EnterKwWritetime(c *KwWritetimeContext)

	// EnterKwToken is called when entering the kwToken production.
	EnterKwToken(c *KwTokenContext)

	// EnterKwTablets is called when entering the kwTablets production.
	EnterKwTablets(c *KwTabletsContext)
	...
	// EnterKwCounter is called when entering the kwCounter production.
	EnterKwCounter(c *KwCounterContext)

	// EnterKwDescribe is called when entering the kwDescribe production.
	EnterKwDescribe(c *KwDescribeContext)

	// EnterKwCluster is called when entering the kwCluster production.
	EnterKwCluster(c *KwClusterContext)

	// EnterKwOnly is called when entering the kwOnly production.
	EnterKwOnly(c *KwOnlyContext)

	// EnterKwInternals is called when entering the kwInternals production.
	EnterKwInternals(c *KwInternalsContext)

	// EnterKwPasswords is called when entering the kwPasswords production.
	EnterKwPasswords(c *KwPasswordsContext)
	...
	// EnterKwTypes is called when entering the kwTypes production.
	EnterKwTypes(c *KwTypesContext)

	// EnterKwAggregates is called when entering the kwAggregates production.
	EnterKwAggregates(c *KwAggregatesContext)

	// EnterKwColumnfamily is called when entering the kwColumnfamily production.
	EnterKwColumnfamily(c *KwColumnfamilyContext)

	// EnterKwService is called when entering the kwService production.
	EnterKwService(c *KwServiceContext)

	// EnterKwLevel is called when entering the kwLevel production.
	EnterKwLevel(c *KwLevelContext)

	// EnterKwLevels is called when entering the kwLevels production.
	EnterKwLevels(c *KwLevelsContext)

	// EnterKwAttach is called when entering the kwAttach production.
	EnterKwAttach(c *KwAttachContext)

	// EnterKwDetach is called when entering the kwDetach production.
	EnterKwDetach(c *KwDetachContext)

	// EnterKwAttached is called when entering the kwAttached production.
	EnterKwAttached(c *KwAttachedContext)

	// EnterKwEffective is called when entering the kwEffective production.
	EnterKwEffective(c *KwEffectiveContext)
	...
	// EnterKwReducefunc is called when entering the kwReducefunc production.
	EnterKwReducefunc(c *KwReducefuncContext)

	// EnterKwNologin is called when entering the kwNologin production.
	EnterKwNologin(c *KwNologinContext)

	// EnterKwUsers is called when entering the kwUsers production.
	EnterKwUsers(c *KwUsersContext)

	// EnterKwHashed is called when entering the kwHashed production.
	EnterKwHashed(c *KwHashedContext)

	// EnterKwEmpty is called when entering the kwEmpty production.
	EnterKwEmpty(c *KwEmptyContext)

	// EnterKwConcurrency is called when entering the kwConcurrency production.
	EnterKwConcurrency(c *KwConcurrencyContext)

	// EnterKwVectorSearchIndexing is called when entering the kwVectorSearchIndexing production.
	EnterKwVectorSearchIndexing(c *KwVectorSearchIndexingContext)
	...
	// ExitMvWhereSpec is called when exiting the mvWhereSpec production.
	ExitMvWhereSpec(c *MvWhereSpecContext)

	// ExitMvWhereClause is called when exiting the mvWhereClause production.
	ExitMvWhereClause(c *MvWhereClauseContext)
	...
	// ExitStaticColumn is called when exiting the staticColumn production.
	ExitStaticColumn(c *StaticColumnContext)
	...
	// ExitBatchStatementList is called when exiting the batchStatementList production.
	ExitBatchStatementList(c *BatchStatementListContext)

	// ExitBatchStatement is called when exiting the batchStatement production.
	ExitBatchStatement(c *BatchStatementContext)

	// ExitBatchInsert is called when exiting the batchInsert production.
	ExitBatchInsert(c *BatchInsertContext)

	// ExitBatchUpdate is called when exiting the batchUpdate production.
	ExitBatchUpdate(c *BatchUpdateContext)

	// ExitBatchDelete is called when exiting the batchDelete production.
	ExitBatchDelete(c *BatchDeleteContext)
	...
	// ExitTabletsSpec is called when exiting the tabletsSpec production.
	ExitTabletsSpec(c *TabletsSpecContext)

	// ExitTabletsOptions is called when exiting the tabletsOptions production.
	ExitTabletsOptions(c *TabletsOptionsContext)

	// ExitTabletsOption is called when exiting the tabletsOption production.
	ExitTabletsOption(c *TabletsOptionContext)
	...
	// ExitIndexUsing is called when exiting the indexUsing production.
	ExitIndexUsing(c *IndexUsingContext)
	...
	// ExitIfConditionValue is called when exiting the ifConditionValue production.
	ExitIfConditionValue(c *IfConditionValueContext)
	...
	// ExitAssignmentIndexKey is called when exiting the assignmentIndexKey production.
	ExitAssignmentIndexKey(c *AssignmentIndexKeyContext)

	// ExitAssignmentSet is called when exiting the assignmentSet production.
	ExitAssignmentSet(c *AssignmentSetContext)

	// ExitAssignmentSetElement is called when exiting the assignmentSetElement production.
	ExitAssignmentSetElement(c *AssignmentSetElementContext)

	// ExitAssignmentMap is called when exiting the assignmentMap production.
	ExitAssignmentMap(c *AssignmentMapContext)

	// ExitAssignmentMapEntry is called when exiting the assignmentMapEntry production.
	ExitAssignmentMapEntry(c *AssignmentMapEntryContext)

	// ExitAssignmentMapKey is called when exiting the assignmentMapKey production.
	ExitAssignmentMapKey(c *AssignmentMapKeyContext)

	// ExitAssignmentMapValue is called when exiting the assignmentMapValue production.
	ExitAssignmentMapValue(c *AssignmentMapValueContext)
	...
	// ExitJsonDefault is called when exiting the jsonDefault production.
	ExitJsonDefault(c *JsonDefaultContext)
	...
	// ExitGroupBySpec is called when exiting the groupBySpec production.
	ExitGroupBySpec(c *GroupBySpecContext)

	// ExitBypassCacheSpec is called when exiting the bypassCacheSpec production.
	ExitBypassCacheSpec(c *BypassCacheSpecContext)

	// ExitPerPartitionLimitSpec is called when exiting the perPartitionLimitSpec production.
	ExitPerPartitionLimitSpec(c *PerPartitionLimitSpecContext)

	// ExitUsingTimeoutSpec is called when exiting the usingTimeoutSpec production.
	ExitUsingTimeoutSpec(c *UsingTimeoutSpecContext)

	// ExitPruneMaterializedView is called when exiting the pruneMaterializedView production.
	ExitPruneMaterializedView(c *PruneMaterializedViewContext)
	...
	// ExitDescribeInternals is called when exiting the describeInternals production.
	ExitDescribeInternals(c *DescribeInternalsContext)

	// ExitServiceLevelName is called when exiting the serviceLevelName production.
	ExitServiceLevelName(c *ServiceLevelNameContext)

	// ExitServiceLevel is called when exiting the serviceLevel production.
	ExitServiceLevel(c *ServiceLevelContext)

	// ExitServiceLevels is called when exiting the serviceLevels production.
	ExitServiceLevels(c *ServiceLevelsContext)

	// ExitCreateServiceLevel is called when exiting the createServiceLevel production.
	ExitCreateServiceLevel(c *CreateServiceLevelContext)

	// ExitAlterServiceLevel is called when exiting the alterServiceLevel production.
	ExitAlterServiceLevel(c *AlterServiceLevelContext)

	// ExitDropServiceLevel is called when exiting the dropServiceLevel production.
	ExitDropServiceLevel(c *DropServiceLevelContext)

	// ExitAttachServiceLevel is called when exiting the attachServiceLevel production.
	ExitAttachServiceLevel(c *AttachServiceLevelContext)

	// ExitDetachServiceLevel is called when exiting the detachServiceLevel production.
	ExitDetachServiceLevel(c *DetachServiceLevelContext)

	// ExitListServiceLevel is called when exiting the listServiceLevel production.
	ExitListServiceLevel(c *ListServiceLevelContext)
	...
	// ExitPruneUsingSpec is called when exiting the pruneUsingSpec production.
	ExitPruneUsingSpec(c *PruneUsingSpecContext)
	...
	// ExitScyllaClusteringBound is called when exiting the scyllaClusteringBound production.
	ExitScyllaClusteringBound(c *ScyllaClusteringBoundContext)

	// ExitFunctionCall is called when exiting the functionCall production.
	ExitFunctionCall(c *FunctionCallContext)

	// ExitCastCall is called when exiting the castCall production.
	ExitCastCall(c *CastCallContext)

	// ExitQualifiedFunctionCall is called when exiting the qualifiedFunctionCall production.
	ExitQualifiedFunctionCall(c *QualifiedFunctionCallContext)
	...
	// ExitNamedMarker is called when exiting the namedMarker production.
	ExitNamedMarker(c *NamedMarkerContext)
	...
	// ExitReservedKeywordAsColumn is called when exiting the reservedKeywordAsColumn production.
	ExitReservedKeywordAsColumn(c *ReservedKeywordAsColumnContext)

	// ExitColumnRef is called when exiting the columnRef production.
	ExitColumnRef(c *ColumnRefContext)

	// ExitReservedKeywordAsTable is called when exiting the reservedKeywordAsTable production.
	ExitReservedKeywordAsTable(c *ReservedKeywordAsTableContext)

	// ExitReservedTypeAsTable is called when exiting the reservedTypeAsTable production.
	ExitReservedTypeAsTable(c *ReservedTypeAsTableContext)
	...
	// ExitDataTypeArg is called when exiting the dataTypeArg production.
	ExitDataTypeArg(c *DataTypeArgContext)
	...
	// ExitKwBypass is called when exiting the kwBypass production.
	ExitKwBypass(c *KwBypassContext)

	// ExitKwCache is called when exiting the kwCache production.
	ExitKwCache(c *KwCacheContext)

	// ExitKwTimeout is called when exiting the kwTimeout production.
	ExitKwTimeout(c *KwTimeoutContext)

	// ExitKwPrune is called when exiting the kwPrune production.
	ExitKwPrune(c *KwPruneContext)

	// ExitKwPer is called when exiting the kwPer production.
	ExitKwPer(c *KwPerContext)

	// ExitKwPartition is called when exiting the kwPartition production.
	ExitKwPartition(c *KwPartitionContext)

	// ExitKwGroup is called when exiting the kwGroup production.
	ExitKwGroup(c *KwGroupContext)

	// ExitKwStatic is called when exiting the kwStatic production.
	ExitKwStatic(c *KwStaticContext)

	// ExitKwCast is called when exiting the kwCast production.
	ExitKwCast(c *KwCastContext)

	// ExitKwLike is called when exiting the kwLike production.
	ExitKwLike(c *KwLikeContext)

	// ExitKwWritetime is called when exiting the kwWritetime production.
	ExitKwWritetime(c *KwWritetimeContext)

	// ExitKwToken is called when exiting the kwToken production.
	ExitKwToken(c *KwTokenContext)

	// ExitKwTablets is called when exiting the kwTablets production.
	ExitKwTablets(c *KwTabletsContext)
	...
	// ExitKwCounter is called when exiting the kwCounter production.
	ExitKwCounter(c *KwCounterContext)

	// ExitKwDescribe is called when exiting the kwDescribe production.
	ExitKwDescribe(c *KwDescribeContext)

	// ExitKwCluster is called when exiting the kwCluster production.
	ExitKwCluster(c *KwClusterContext)

	// ExitKwOnly is called when exiting the kwOnly production.
	ExitKwOnly(c *KwOnlyContext)

	// ExitKwInternals is called when exiting the kwInternals production.
	ExitKwInternals(c *KwInternalsContext)

	// ExitKwPasswords is called when exiting the kwPasswords production.
	ExitKwPasswords(c *KwPasswordsContext)
	...
	// ExitKwTypes is called when exiting the kwTypes production.
	ExitKwTypes(c *KwTypesContext)

	// ExitKwAggregates is called when exiting the kwAggregates production.
	ExitKwAggregates(c *KwAggregatesContext)

	// ExitKwColumnfamily is called when exiting the kwColumnfamily production.
	ExitKwColumnfamily(c *KwColumnfamilyContext)

	// ExitKwService is called when exiting the kwService production.
	ExitKwService(c *KwServiceContext)

	// ExitKwLevel is called when exiting the kwLevel production.
	ExitKwLevel(c *KwLevelContext)

	// ExitKwLevels is called when exiting the kwLevels production.
	ExitKwLevels(c *KwLevelsContext)

	// ExitKwAttach is called when exiting the kwAttach production.
	ExitKwAttach(c *KwAttachContext)

	// ExitKwDetach is called when exiting the kwDetach production.
	ExitKwDetach(c *KwDetachContext)

	// ExitKwAttached is called when exiting the kwAttached production.
	ExitKwAttached(c *KwAttachedContext)

	// ExitKwEffective is called when exiting the kwEffective production.
	ExitKwEffective(c *KwEffectiveContext)
	...
	// ExitKwReducefunc is called when exiting the kwReducefunc production.
	ExitKwReducefunc(c *KwReducefuncContext)

	// ExitKwNologin is called when exiting the kwNologin production.
	ExitKwNologin(c *KwNologinContext)

	// ExitKwUsers is called when exiting the kwUsers production.
	ExitKwUsers(c *KwUsersContext)

	// ExitKwHashed is called when exiting the kwHashed production.
	ExitKwHashed(c *KwHashedContext)

	// ExitKwEmpty is called when exiting the kwEmpty production.
	ExitKwEmpty(c *KwEmptyContext)

	// ExitKwConcurrency is called when exiting the kwConcurrency production.
	ExitKwConcurrency(c *KwConcurrencyContext)

	// ExitKwVectorSearchIndexing is called when exiting the kwVectorSearchIndexing production.
	ExitKwVectorSearchIndexing(c *KwVectorSearchIndexingContext)
}
